...
var server = http.createServer(function(request, response){
    ...
    if(request.method == "POST"){
        ...
        request.addListener('end', function() {
            try{
                requestQueue[data.request] = JSON.parse(data);
                //console.log(requestQueue[data.request].call.name);
                targets = requestProcess(requestQueue[data.request], request, response);
